...
class AI_SERVICE_DEFINE:
    ...
    SERVICE_NOTION_AI = 6
    SERVICE_WORKS_AI = 7
    SERVICE_CLAUDE_CODE = 8
    
    SERVICE_OPENAPI_COPILOT = 10
    SERVICE_CURSOR_AI = 11
    ...
    NAME_SERVICE_CURSOR_AI = "cursor.ai"
...
AI_SERVICE_NAME_MAP = {
    ...
    AI_SERVICE_DEFINE.SERVICE_NOTION_AI : AI_SERVICE_DEFINE.NAME_SERVICE_NOTION_AI,
    AI_SERVICE_DEFINE.SERVICE_WORKS_AI : AI_SERVICE_DEFINE.NAME_SERVICE_WORKS_AI,
    AI_SERVICE_DEFINE.SERVICE_CLAUDE_CODE : AI_SERVICE_DEFINE.NAME_SERVICE_CLAUDE_CODE,
    
    AI_SERVICE_DEFINE.SERVICE_OPENAPI_COPILOT : AI_SERVICE_DEFINE.NAME_SERVICE_OPENAPI_COPILOT,
    AI_SERVICE_DEFINE.SERVICE_CURSOR_AI : AI_SERVICE_DEFINE.NAME_SERVICE_CURSOR_AI,
}
